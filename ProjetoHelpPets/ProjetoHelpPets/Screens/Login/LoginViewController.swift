...
class LoginViewController: UIViewController {
    ...
    private lazy var emailLoginPageTextField: UITextField = {
    ...
    private lazy var passwordLoginPageTextField: UITextField = {
        let view = UITextField(frame: .zero)
        view.backgroundColor = UIColor(named: "ComponentsBackgroundColor")
        view.textAlignment = .left
    ...
    private lazy var loginButtonLoginPage: UIButton = {
        let view = UIButton(frame: .zero)
